...
const translations = {
  ar: {
    ...
    'store.orders.total': 'إجمالي الطلبات',
    'store.refresh': 'تحديث',
    'store.logout': 'تسجيل خروج',
    ...
    'no.orders.returned': 'لا توجد طلبات مرتجع��',
    ...
    'write.custom.reason': 'أو اكتب سبباً مخصصاً',
    ...
    'order.total.without.delivery': 'إجمالي الطلب (بدون التوصيل)',
    'customer.details': 'تفاصيل العميل',
    'customer.details.delivery': 'تفاصيل الزبون',
    'order.details.returned': 'تفاصيل الطلب المسترجع',
    'return.reason': 'سبب الإرجاع',
    'products': 'المنتجات',
    'products.required': 'المنتجات المطلوبة',

    // Field labels
    'name.label': 'الاسم:',
    'phone.label': 'الهاتف:',
    'address.label': 'العنوان:',
    'total.amount.label': 'المبلغ الإجمالي:',
    'delivery.date.label': 'تاريخ التسليم:',
    'return.date.label': 'تاريخ الإرجاع:',
    'order.date.label': 'تاريخ الطلب:',
    'cannot.change': 'لا يمكن التغيير',
    'customer.rejected': 'رفض الزبون',
    'customer.rejection': 'رفض الزبون',
    'returned.field': 'حقل مرتجع',
    'ready.for.delivery': 'جاهز للتسليم',
    'no.rejected.orders.customer': 'لا توجد طلبات مرفوضة من الزبون',
    'product.details.label': 'تفاصيل المنتج:',
    'amount.label': 'المبلغ:',
    'unavailable.reason': 'غير متوفر: إدخال سبب عدم التوفر وإرجاع للمدير',
    'order.rejected.by.customer': 'تم رفض الطلب من قبل الزبون',
    'cannot.deliver.rejected': 'لا يمكن تسليم أو استرجاع هذا الطلب لأنه تم رفضه من قبل الزبون',
    'no.returned.orders': 'لا توجد طلبات مرتجعة',

    // Store UI translations
    'customer.details.title': 'تفاصيل العميل',
    'name.field': 'الاسم',
    'phone.field': 'الهاتف',
    'address.field': 'العنوان',
    'amount.field': 'المبلغ',
    'products.field': 'المنتجات',
    'inventory.check.title': 'فحص المخزون من المتجر',
    'responded.at': 'تم الرد في',
    'store.confirmed.availability': 'المتجر أكد توفر هذا المنتج في مخزونه',
    'products.count': 'المنتجات ({count} منتج)',
    'store.field': 'المتجر',
    'assigned.store': 'المتجر المعين',
    'total.amount.no.delivery': 'إجمالي المبلغ (بدون التوصيل)',

    // Additional Customer Details translations
    'order.word': 'طلب',
    'customer.notes.label': 'ملاحظات العميل:',
    'return.reason.label': 'سبب الإرجاع:',

    // Store inventory status translations
    'availability.status.label': 'حالة التوفر:',
    'in.stock.full': 'متوفر في المخزون',
    'not.in.stock.full': 'غير متوفر في المخزون',

    // Store order details translations
    'store.order.details': 'تفاصيل الطلب',
    'order.available': 'متوفر',

    // Connection status translations
    'realtime.connected': 'متصل مباشر',
    'periodic.update': 'تحديث دوري',
  ...
  en: {
    ...
    'store.orders.total': 'Total Orders',
    ...
    // Store specific translations
    'order.total.without.delivery': 'Order Total (without delivery)',
    'customer.details': 'Customer Details',
    'customer.details.delivery': 'Customer Details',
    'order.details.returned': 'Returned Order Details',
    'return.reason': 'Return Reason',
    'products': 'Products',
    'products.required': 'Required Products',
    ...
    'customer.rejection': 'Customer Rejection',
    'returned.field': 'Returned Field',
    'ready.for.delivery': 'Ready for Delivery',
    'no.rejected.orders.customer': 'No customer rejected orders',
    'product.details.label': 'Product Details:',
    'amount.label': 'Amount:',
    'unavailable.reason': 'Unavailable: Enter reason for unavailability and return to admin',
    'order.rejected.by.customer': 'Order rejected by customer',
    'cannot.deliver.rejected': 'Cannot deliver or return this order as it was rejected by customer',
    'no.returned.orders': 'No returned orders',
    ...
    'inventory.check.title': 'Store Inventory Check',
    'responded.at': 'Responded at',
    'store.confirmed.availability': 'Store confirmed this product is available in their inventory',
    'products.count': 'Products ({count} product)',
    'store.field': 'Store',
    'assigned.store': 'Assigned Store',
    'total.amount.no.delivery': 'Total Amount (without delivery)',

    // Additional Customer Details translations
    'order.word': 'Order',
    'customer.notes.label': 'Customer Notes:',
    'return.reason.label': 'Return Reason:',

    // Store inventory status translations
    'availability.status.label': 'Availability Status:',
    'in.stock.full': 'Available in stock',
    'not.in.stock.full': 'Unavailable in stock',

    // Store order details translations
    'store.order.details': 'Order Details',
    'order.available': 'Available',

    // Connection status translations
    'realtime.connected': 'Live Connected',
